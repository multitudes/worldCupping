...
// This extension will create predefined static colors that can be used in my app like: Color.lightcCoffee or Color.darkCoffee.
// I use a custom init to create colors from decimal values between 0-255
